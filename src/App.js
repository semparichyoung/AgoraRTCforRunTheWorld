...
export default function App() {
  ...
  return (
    <div className="App">
      <form id="form" className="row col l12 s12">
        <div className="row container col l12 s12">
          <div className="col" style={{ minWidth: 433, maxWidth: 443 }}>
            <div className="card" style={{ marginTop: 0, marginBottom: 0 }}>
              <div className="row card-content" style={{ marginBottom: 0 }}>
                <div className="input-field">
                  <label htmlFor="appID" className="active">
                    App ID
                  </label>
                  <input type="text" placeholder="App ID" name="appID" />
                </div>
                <div className="input-field">
                  <label htmlFor="channel" className="active">
                    Channel
                  </label>
            ...
            <ul
              className="collapsible card agora-secondary-border"
              style={{ marginTop: ".4rem", border: 1 }}
            >
              <li>
                <div className="collapsible-header agora-secondary-bg">
                  <h6 className="center-align">ADVANCED SETTINGS</h6>
                </div>
                <div className="collapsible-body card-content">
                  <div className="row">
                    <div className="col s12">
                      <div className="input-field">
                      ...
                      <div className="input-field">
                        <label htmlFor="cameraId" className="active">
                          CAMERA
                        </label>
                        <select name="cameraId" id="cameraId"></select>
                      </div>
                      <div className="input-field">
                        <label htmlFor="microphoneId" className="active">
                          MICROPHONE
                        </label>
                        <select name="microphoneId" id="microphoneId"></select>
                      </div>
                      <div className="input-field">
                        <label htmlFor="cameraResolution" className="active">
                          CAMERA RESOLUTION
                        </label>
                        <select
                      ...
                      <div className="row col s12">
                        <div className="row">
                          <label htmlFor="mode" className="active">
                            MODE
                          </label>
                        </div>
                        <div className="row">
                      ...
                      <div className="row col s12">
                        <div className="row">
                          <label htmlFor="codec" className="active">
                            CODEC
                          </label>
                        </div>
                        <div className="row">
        ...
        onClick={() => {
          ...
          if (muted) {
            if (rtc.localStream.hasVideo()) {
              return rtc.localStream.muteVideo();
            } else if (rtc.localStream.hasAudio()) {
              return rtc.localStream.muteAudio();
            } else {
              return false;
            }
          } else {
            if (rtc.localStream.hasVideo()) {
              return rtc.localStream.unmuteVideo();
            } else if (rtc.localStream.hasAudio()) {
              return rtc.localStream.unmuteAudio();
            } else {
              return false;
            }
          }
